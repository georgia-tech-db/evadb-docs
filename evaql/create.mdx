...
To register an user-defined function, specify the implementation details
of the UDF.
...
To create a view with materialized results like the outputs of deep
learning model, use the following template:
