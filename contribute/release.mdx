---
title: EvaDB Release Guide
sidebarTitle: Release Guide
---
...
16. Add the new tag to `the EvaDB project on [ReadTheDocs](https://readthedocs.org/projects/evadb),
...
Credits: [Snorkel](https://github.com/snorkel-team/snorkel/blob/main/RELEASING.md)
