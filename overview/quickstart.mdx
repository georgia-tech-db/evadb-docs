...
Here is an [illustrative MNIST digit classification app](https://evadb.readthedocs.io/en/stable/source/tutorials/01-mnist.html) using EvaDB.
...
The notebook works on [Google Colab](https://colab.research.google.com/github/georgia-tech-db/evadb/blob/master/tutorials/01-mnist.ipynb).

![MNIST](images/reference/mnist.png)